...
class PedidosDotController extends ActiveRecord
{
    ...
    public static function buscarAPI()
    {
        ...
        try {
            ...
            $sql = "SELECT p.ped_id, p.ped_cant_sol, p.ped_fecha_sol, p.ped_observ, p.ped_estado,
                    ...
                    FROM haga_ped_dot p
                    LEFT JOIN haga_personal_dot per ON p.ped_per_id = per.per_id
    ...
    public static function eliminarAPI()
    {
        ...
        try {
            $sql = "UPDATE haga_ped_dot SET ped_situacion = 0 WHERE ped_id = $id AND ped_situacion = 1";
            $resultado = PedidosDot::getDB()->exec($sql);
