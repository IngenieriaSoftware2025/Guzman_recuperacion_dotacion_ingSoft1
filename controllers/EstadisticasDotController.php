    ...
    public static function buscarAPI()
    {
        ...
        try {
            ...
            $consultaDotaciones = "SELECT 
                                  ...
                                  FROM haga_ent_dot e
                                  INNER JOIN haga_inv_dot i ON e.ent_inv_id = i.inv_id
                                  INNER JOIN haga_dot_img pr ON i.inv_prenda_id = pr.prenda_id
            ...
            $consultaTallas = "SELECT 
                              ...
                              FROM haga_inv_dot i
                              INNER JOIN haga_tallas_dot t ON i.inv_talla_id = t.talla_id
