...
class InventarioDotController extends ActiveRecord
{
    ...
    public static function guardarAPI()
    {
        ...
        $inventarioExistente = InventarioDot::fetchFirst("SELECT * FROM haga_inv_dot WHERE inv_prenda_id = {$_POST['inv_prenda_id']} AND inv_talla_id = {$_POST['inv_talla_id']} AND inv_lote = '{$_POST['inv_lote']}'");
    ...
    public static function buscarAPI()
    {
        ...
        try {
            ...
            $sql = "SELECT i.inv_id, i.inv_cant_disp, i.inv_cant_total, i.inv_fecha_ing, 
                    ...
                    FROM haga_inv_dot i
                    LEFT JOIN haga_dot_img p ON i.inv_prenda_id = p.prenda_id
    ...
    public static function eliminarAPI()
    {
        ...
        try {
            $sql = "UPDATE haga_inv_dot SET inv_situacion = 0 WHERE inv_id = $id AND inv_situacion = 1";
            $resultado = InventarioDot::getDB()->exec($sql);
