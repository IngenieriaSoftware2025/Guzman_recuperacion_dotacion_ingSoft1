...
class TallasDotController extends ActiveRecord
{
    ...
    public static function guardarAPI()
    {
        ...
        $tallaExistente = TallasDot::fetchFirst("SELECT * FROM haga_tallas_dot WHERE talla_nombre = '{$_POST['talla_nombre']}' AND talla_prenda_id = {$_POST['talla_prenda_id']}");
        if ($tallaExistente) {
            http_response_code(400);
            echo json_encode([
                'codigo' => 0,
    ...
    public static function buscarAPI()
    {
        ...
        try {
            ...
            $sql = "SELECT t.talla_id, t.talla_nombre, t.talla_desc, 
                    ...
                    FROM haga_tallas_dot t
                    LEFT JOIN haga_dot_img p ON t.talla_prenda_id = p.prenda_id
    ...
    public static function modificarAPI()
    {
        ...
        $tallaExistente = TallasDot::fetchFirst("SELECT * FROM haga_tallas_dot WHERE talla_nombre = '{$_POST['talla_nombre']}' AND talla_prenda_id = {$_POST['talla_prenda_id']} AND talla_id != {$_POST['talla_id']}");
        if ($tallaExistente) {
            http_response_code(400);
            echo json_encode([
                'codigo' => 0,
        ...
        try {
            $sql = "UPDATE haga_tallas_dot SET 
    ...
    public static function eliminarAPI()
    {
        ...
        try {
            $sql = "UPDATE haga_tallas_dot SET talla_situacion = 0 WHERE talla_id = $id AND talla_situacion = 1";
            $resultado = TallasDot::getDB()->exec($sql);
