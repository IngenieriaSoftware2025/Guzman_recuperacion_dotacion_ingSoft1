...
class AplicacionController extends ActiveRecord
{
    ...
    public static function modificarAPI()
    {
        ...
        $appExistente = Aplicacion::fetchFirst("SELECT * FROM haga_aplicacion WHERE app_nombre_corto = '{$_POST['app_nombre_corto']}' AND app_id != {$_POST['app_id']}");
        if ($appExistente) {
            http_response_code(400);
            echo json_encode([
                'codigo' => 0,
        ...
        try {
            $sql = "UPDATE haga_aplicacion SET 
    ...
    public static function eliminarAPI()
    {
        ...
        try {
            $sql = "UPDATE haga_aplicacion SET app_situacion = 0 WHERE app_id = $id AND app_situacion = 1";
            $resultado = Aplicacion::getDB()->exec($sql);
