...
const cargarPrendas = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/tallasDot/prendas';
    const config = {
        method: 'GET'
    };
...
const guardarTalla = async (evento) => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/tallasDot/guardar';
    const config = {
        method: 'POST',
...
const BuscarTallas = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/tallasDot/buscar';
    const config = {
        method: 'POST'
    };
...
const ModificarTalla = async () => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/tallasDot/modificar';
    const config = {
        method: 'POST',
        body: datosFormulario
    };
...
const EliminarTalla = async (evento) => {
    ...
    if (resultado.isConfirmed) {
        try {
            const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/tallasDot/eliminar?id=${id}`;
