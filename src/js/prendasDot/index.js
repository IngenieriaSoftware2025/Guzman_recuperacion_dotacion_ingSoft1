...
const guardarPrenda = async (evento) => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/prendasDot/guardar';
    const config = {
        method: 'POST',
...
const BuscarPrendas = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/prendasDot/buscar';
    const config = {
        method: 'POST'
    };
...
const ModificarPrenda = async () => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/prendasDot/modificar';
    const config = {
        method: 'POST',
        body: datosFormulario
    };
...
const EliminarPrenda = async (evento) => {
    ...
    if (resultado.isConfirmed) {
        try {
            const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/prendasDot/eliminar?id=${id}`;
