...
const cargarEstadisticas = async () => {
    try {
        const respuesta = await fetch('/Guzman_Recuperacion_Dotacion_ingSoft1/estadisticas/buscar');
...
const cargarEstadisticasActividades = async () => {
    try {
        const respuesta = await fetch('/Guzman_Recuperacion_Dotacion_ingSoft1/estadisticas/buscarActividades');
        const datos = await respuesta.json();
