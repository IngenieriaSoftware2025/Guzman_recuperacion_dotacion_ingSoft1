...
const guardarPersonal = async (evento) => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/personalDot/guardar';
    const config = {
        method: 'POST',
...
const BuscarPersonal = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/personalDot/buscar';
    const config = {
        method: 'POST'
    };
...
const ModificarPersonal = async () => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/personalDot/modificar';
    const config = {
        method: 'POST',
        body: datosFormulario
    };
...
const EliminarPersonal = async (evento) => {
    ...
    if (resultado.isConfirmed) {
        try {
            const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/personalDot/eliminar?id=${id}`;
