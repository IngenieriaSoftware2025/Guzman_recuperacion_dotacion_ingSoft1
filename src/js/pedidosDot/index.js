...
const cargarPersonal = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/personal';
    const config = {
        method: 'GET'
    };
...
const cargarPrendas = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/prendas';
    const config = {
        method: 'GET'
    };
...
const cargarTallas = async (prendaId) => {
    const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/tallas?prenda_id=${prendaId}`;
    const config = {
        method: 'GET'
    };
...
const guardarPedido = async (evento) => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/guardar';
    const config = {
        method: 'POST',
...
const BuscarPedidos = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/buscar';
    const config = {
        method: 'POST'
    };
...
const ModificarPedido = async () => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/modificar';
    const config = {
        method: 'POST',
        body: datosFormulario
    };
...
const EliminarPedido = async (evento) => {
    ...
    if (resultado.isConfirmed) {
        try {
            const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/pedidosDot/eliminar?id=${id}`;
