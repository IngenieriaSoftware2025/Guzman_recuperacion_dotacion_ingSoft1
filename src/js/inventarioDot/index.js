...
const cargarPrendas = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/inventarioDot/prendas';
    const config = {
        method: 'GET'
    };
...
const cargarTallas = async (prendaId) => {
    const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/inventarioDot/tallas?prenda_id=${prendaId}`;
    const config = {
        method: 'GET'
    };
...
const guardarInventario = async (evento) => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/inventarioDot/guardar';
    const config = {
        method: 'POST',
...
const BuscarInventario = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/inventarioDot/buscar';
    const config = {
        method: 'POST'
    };
...
const ModificarInventario = async () => {
    ...
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/inventarioDot/modificar';
    const config = {
        method: 'POST',
        body: datosFormulario
    };
...
const EliminarInventario = async (evento) => {
    ...
    if (resultado.isConfirmed) {
        try {
            const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/inventarioDot/eliminar?id=${id}`;
