...
const cargarUsuarios = async () => {
    const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/historial/buscarUsuariosAPI`;
    const configuracion = {
        method: 'GET'
    }
...
const cargarAplicaciones = async () => {
    const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/historial/buscarAplicacionesAPI`;
    const configuracion = {
        method: 'GET'
    }
...
const cargarRutas = async (idAplicacion = '') => {
    ...
    const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/historial/buscarRutasAPI${parametros.toString() ? '?' + parametros.toString() : ''}`;
    const configuracion = {
        method: 'GET'
    }
...
const buscarActividades = async () => {
    ...
    const url = `/Guzman_Recuperacion_Dotacion_ingSoft1/historial/buscarAPI${parametros.toString() ? '?' + parametros.toString() : ''}`;
    const configuracion = {
        method: 'GET'
    }
