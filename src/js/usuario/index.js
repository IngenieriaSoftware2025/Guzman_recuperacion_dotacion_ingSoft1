...
const guardarUsuario = async e => {
  ...
  try {
    ...
    const url = "/Guzman_Recuperacion_Dotacion_ingSoft1/usuario/guardar"
    const config = {
      method: 'POST',
      body
    }
...
const BuscarUsuarios = async () => {
    const url = '/Guzman_Recuperacion_Dotacion_ingSoft1/usuario/buscar';
    const config = {
        method: 'POST'
    }
        ...
        if (codigo == 1) {
            ...
            data.forEach((usuario, index) => {
                ...
                if (usuario.usuario_fotografia && usuario.usuario_fotografia !== '' && usuario.usuario_fotografia !== null) {
                    ...
                    const rutaImagen = `/Guzman_Recuperacion_Dotacion_ingSoft1/usuario/imagen?dpi=${usuario.usuario_dpi}`;
