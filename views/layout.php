...
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient shadow-lg sticky-top" style="background: linear-gradient(45deg, #212529, #495057);">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold text-warning d-flex align-items-center" href="/baseguzman">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item mx-1">
                    <a class="nav-link active rounded-pill px-3 py-2 fw-bold bg-success bg-opacity-25" aria-current="page" href="/baseguzman/usuarios">
                ...
                <li class="nav-item dropdown mx-1">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark shadow border-light animated fadeIn" aria-labelledby="navbarDropdownMenuLink">
                        <li><h6 class="dropdown-header">GESTIÓN DE SISTEMA</h6></li>
                        <li><a class="dropdown-item text-white-50 fw-bold" href="/baseguzman/usuarios"><i class="bi bi-person-badge me-2"></i>Usuarios</a></li>
            ...
            <form class="d-flex">
                <div class="input-group">
                    <input class="form-control bg-dark bg-opacity-50 text-light border-secondary" type="search" placeholder="Buscar..." aria-label="Search">
